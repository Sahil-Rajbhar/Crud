             ...
             <form action="{{ route('employees.update',$emp->id) }}" method="post">
                ...
                @method('PUT')
                  <table>
                        <tr>
                            <td>Name</td>
                            <td> <input type="text" name="emp_name" id="" value = {{ old('emp_name', $emp->employe_name) }}> <br><br>
                        ...
                        <tr>
                            ...
                            <td><input type="text" name="emp_email" id="" value = {{ old('emp_email', $emp->employe_email) }}> <br><br>
