<div class="w-full max-w-xs">
    ...
    <div class="mb-6">
        ...
        {{ Form::email('email', null, ['class'=>'shadow appearance-none border border-blue-500 rounded w-full py-2 px-3 text-gray-700 mb-3 leading-tight focus:outline-none focus:shadow-outline']) }}<br><br>
            @if ($errors->has('email'))
                <ul>
                    <li>
    ...
    <div class="flex items-center justify-between">    
        ...
        {{ Form::submit('Submit', ['class' => 'bg-blue-500 hover:bg-white text-white hover:text-blue-500 font-bold py-2 px-4 border-b-4 border-blue-700 hover:border-blue-500 rounded']) }}
    </div>
    <br>
